...
The **Companion Discord Bot** is a centralized, standalone Discord bot designed to enhance the tabletop RPG experience by integrating with both the **Calendar & Scheduling Tool** and **Session Notes Tool**. Acting as a powerful assistant for Dungeon Masters (DMs) and players alike, the bot provides an intuitive interface to manage group scheduling, track session summaries, and coordinate gameplay activities directly within Discord.
